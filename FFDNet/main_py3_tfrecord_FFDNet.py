...
from model_py3_tfrecord_FFDNet import denoiser
    ...
    if args.use_gpu:
        ...
        with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
            ...
            if args.phase == 'train':
                ...
                lr[iter_epoch*7:] = lr[0] / 2.0
                lr[iter_epoch*14:] = lr[0] / 10.0
                lr[iter_epoch*21:] = lr[0] / 20.0
                lr[iter_epoch*28:] = lr[0] / 100.0
                lr[iter_epoch*35:] = lr[0] / 200.0
                lr[iter_epoch*42:] = lr[0] / 1000.0
